...
@section('content')
        ...
        <div class=" p-5 mt-20 mb-5 rounded-lg shadow-sm  overflow-x-auto">
             <h1 class="text-center mt-30 mb-10 text-3xl font-bold">Daftar <span class="text-blue-500">Pengumuman</span></h1>
            <a href="{{ route('pengumuman.create') }}" class="bg-blue-500 px-5 py-3 mt-5 hover:bg-blue-600 text-white rounded">
                Tambah Pengumuman</a>
            <table class="min-w-full bg-white border  rounded-lg shadow-sm mt-5">
                <thead class="bg-gray-100 ">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-white uppercase text-sm font-medium bg-blue-500">Isi</th>
        ...
        <div class="text-center py-10 text-gray-500 italic">
            Tidak ada data pengumuman.
                   ...
                   <td class="px-4 py-2">{{ Str::limit($item->isi, 100) }}</td>
                            ...
                            <td class="px-4 py-2 flex gap-2 items-start">
                                ...
                                <form action="{{ route('pengumuman.destroy', $item->id_pengumuman) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
